        ...
        <div className="wrapper">
            ...
            <form method={'post'} action="">
                ...
                <div className={"result"}>
                    ...
                    <button type='submit' onClick={(e) => clickHandler(e)}>Оставить заявку</button>
                </div>
            </form>
        </div>
    );
